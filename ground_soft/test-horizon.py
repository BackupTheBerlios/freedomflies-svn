...
class HorizonCanvas(MyCanvasBase):
    def InitGL(self):
        print "Init Render"
        m_UnitsPerPixel = 1
    ...
    def SetPitch(self,pitch):
        self.Pitch = pitch
        self.OnDraw()
#end of class HorizonCanvas

class RunDemoApp(wx.App):
    def __init__(self, name="wx.glCanvas test"):
        self.name = name
    ...
    def OnInit(self):
        ...
        e = wx.PaintEvent()
        self.win.OnPaint(e)
        self.win.SetClientSize((400,400))
